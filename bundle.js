...
/* harmony export */   subscribeClick: () => (/* binding */ subscribeClick),
...
let rootElement = {};
const url =  true ? "https://us-central1-just-software.cloudfunctions.net/just-api/subscribe":0;
const justProtect =  true ? "https://just-software-tech.github.io/just-protect-ui/bundle.js": 0;
let clientId = "";
let clientKey = ""

__webpack_require__.g.gotValue = async (v) => {
  ...
  .then((m)=>{
    ...
    if(m.ok){
        ...
        const successMessage = (0,_framework__WEBPACK_IMPORTED_MODULE_0__.div)({
            ...
            (0,_framework__WEBPACK_IMPORTED_MODULE_0__.span)({},[],"you are subscribed")
        ])
...
const subscribeClick = (e) => {
  ...
  if(subscribe.value.trim() === "" || !validEmail(subscribe.value.trim()))
  {
    subscribe.classList.add("error")
    return
  }
  ...
  let nobotholder = (0,_framework__WEBPACK_IMPORTED_MODULE_0__.div)(
    {
      id: "nobot",
      "data-call": "gotValue(val)",
      clientId: clientId,
      clientKey: clientKey,
      salt: subscribe.value
    },
    []
  );
...
const setUp = (el) => {
  ...
  let d = (0,_framework__WEBPACK_IMPORTED_MODULE_0__.div)({}, [
    (0,_framework__WEBPACK_IMPORTED_MODULE_0__.input)(
      {
        placeholder: "email",
        id:"subscribe"
      },
...
console.log("started")
if(document.getElementById("just-subscribe"))
    (0,_app__WEBPACK_IMPORTED_MODULE_0__.setUp)(document.getElementById("just-subscribe"))
})();
